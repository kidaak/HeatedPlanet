...
public class Benchmark_Memory_5Precision extends AbstractBenchmark{
	...
	@Test
	public void args5PR_1GP_1TP() {
		System.out.print("*"+this.getClass().getSimpleName()+".args5PR_1GP_1TP,");
		disableOutput();
		runTest(Constants.args5PR_1GP_1TP);
		enableOutput();
	}
